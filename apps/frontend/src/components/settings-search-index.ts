...
export const settingsSearchIndex: SettingsSearchEntry[] = [
	...
	},
	{
		...
		description: 'Replace the nao name, logos and favicon with your own branding. Enterprise feature.',
		keywords: [
			'white label',
			'whitelabel',
			'branding',
	...
	},
	{
		...
		title: 'Sidebar logo',
		description: 'Replace the top-left logo in the sidebar with your own.',
		keywords: ['logo', 'sidebar', 'brand', 'enterprise'],
		adminOnly: true,
		cloudHidden: true,
	},
	{
		...
		pageLabel: 'White-label',
		section: 'Logos & favicon',
		title: 'Sign-up / login logo',
		description: 'Replace the logo shown on the login and sign-up pages.',
		keywords: ['login logo', 'signup logo', 'auth', 'enterprise'],
		adminOnly: true,
		cloudHidden: true,
	},
	{
