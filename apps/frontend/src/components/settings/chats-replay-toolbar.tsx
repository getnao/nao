			...
			<div className='flex items-center justify-end gap-2'>
				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button variant='ghost' size='sm' className={cn(someUsersUnchecked && 'text-foreground')}>
				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button variant='ghost' size='sm' className={cn(hiddenCount > 0 && 'text-foreground')}>
				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button variant='ghost' size='sm' className={cn(activeFilters.length > 0 && 'text-foreground')}>
