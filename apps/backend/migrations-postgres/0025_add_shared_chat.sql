...
--> statement-breakpoint
ALTER TABLE "shared_chat" ADD CONSTRAINT "shared_chat_project_id_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."project"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shared_chat" ADD CONSTRAINT "shared_chat_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "shared_chat_chatId_idx" ON "shared_chat" USING btree ("chat_id");