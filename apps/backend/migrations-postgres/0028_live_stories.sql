CREATE TABLE "story_data_cache" (
	...
	CONSTRAINT "story_data_cache_chat_id_story_id_pk" PRIMARY KEY("chat_id","story_id")
);
...
ALTER TABLE "story_data_cache" ADD CONSTRAINT "story_data_cache_chat_id_chat_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."chat"("id") ON DELETE cascade ON UPDATE no action;