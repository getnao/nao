...
ALTER TABLE "message_part" ADD CONSTRAINT "file_fields_required" CHECK (CASE WHEN "message_part"."type" = 'file' THEN "message_part"."media_type" IS NOT NULL AND "message_part"."image_id" IS NOT NULL ELSE TRUE END);