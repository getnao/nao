...
CREATE INDEX "context_branch_ownership_projectId_idx" ON "context_branch_ownership" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "context_branch_ownership_userId_idx" ON "context_branch_ownership" USING btree ("user_id");--> statement-breakpoint
