...
export default createTool<story.Input, story.Output>({
	description: [
		...
		'Use <analysis id="..." prompt="..." /> to insert a dynamic text analysis block that is AI-generated based on the story data.',
		'Each analysis block needs a unique id and an optional prompt describing what to analyze.',
		'If the story is set to live mode, analysis blocks are automatically regenerated when data refreshes.',
