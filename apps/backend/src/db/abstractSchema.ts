...
export type DBProjectMcpToolSetting = typeof sqliteSchema.projectMcpToolSetting.$inferSelect;
export type NewProjectMcpToolSetting = typeof sqliteSchema.projectMcpToolSetting.$inferInsert;
