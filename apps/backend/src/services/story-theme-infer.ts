...
const SYSTEM_PROMPT = [
	...
	'- typography.figureFont: "heading" when the brand sets numbers in its display',
	'  face, which editorial and heritage brands almost always do. "body" for a',
	'  product or fintech brand that keeps figures in the UI sans.',
	'- typography.figureScale: how large KPI numbers run, 1 to 3.2. An editorial',
	'  brand with a display serif goes big (2.4 or more); a dense product UI stays',
	'  near 1.6.',
	'- typography.labelStyle: "uppercase-tracked" when small labels on the site are',
	'  set in caps with wide letter-spacing, which is very common; otherwise "plain".',
	'- layout.density: how much air the brand leaves. Fashion, editorial and',
	'  heritage brands are "spacious"; dense product UIs are "compact".',
	'- layout.emphasis: "inverted-hero" when the site alternates a dark block',
	'  against a light page (or the reverse) as a structural device. That rhythm is',
	'  most of why a brand site looks like itself. "none" when every section shares',
	'  one ground.',
	"- charts.barRadius, barGap, lineWidth and axis should match the brand's own",
	'  geometry: square bars and hairline rules for a sharp-cornered brand, rounded',
	'  and airy for a soft one, "minimal" axes for a brand that avoids chrome.',
