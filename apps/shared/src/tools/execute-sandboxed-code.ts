...
export const description = [
	...
	'Secrets the user defined in Settings → Agent → Capabilities → Sandbox secrets are injected as environment variables (listed in the system prompt under "Sandbox Secrets"): read them with `os.environ["NAME"]`, never print them — their values are redacted from the output anyway.',
