...
export const InputSchema = z.object({
	...
	code: z
		...
		.optional()
		.describe(
			'The markdown content. Required for "create" (initial content) and "replace" (new content). Can include charts via <chart query_id="..." /> blocks, SQL tables via <table query_id="..." /> blocks, and dynamic AI-generated text via <analysis id="..." prompt="..." /> blocks. Use <grid cols="2">...</grid> to lay out charts side by side in a responsive grid.',
		),
