...
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `databases/type=*/database=*/schema=*/table=*/` | Per-table files synced from the warehouse: `columns.md`, `preview.md`, and (if enabled in `nao_config.yaml` `templates:`) `query_history.md`, `ai_summary.md`, `profiling.md`                              | If rich per-table docs exist here, **don't restate columns** in `RULES.md` — point to the folder.                                                                     |
