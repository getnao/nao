...
| [import-metabase-dashboard](./import-metabase-dashboard) | Export Metabase dashboards, collections, or saved questions with the nao CLI, then recreate them as nao charts or stories according to user intent. | When migrating Metabase analytics content from an external agent interface. |
