...
| [migrate-tableau-workbook](./migrate-tableau-workbook) | Import Tableau worksheets as nao charts and migrate dashboards or workbooks as nao stories using the nao CLI Tableau connection.                                                                                                                                                                                                                                                                                                                | When a user asks to import, analyze, chart, recreate, or migrate Tableau content.                     |
